defmodule ChessWeb.GameLive.Show do
  ...
  @pieces %{
    "wP" => %{symbol: "\u2659", class: "white-piece"},
    "wR" => %{symbol: "\u2656", class: "white-piece"},
    "wN" => %{symbol: "\u2658", class: "white-piece"},
    "wB" => %{symbol: "\u2657", class: "white-piece"},
    "wQ" => %{symbol: "\u2655", class: "white-piece"},
    "wK" => %{symbol: "\u2654", class: "white-piece"},
    "bP" => %{symbol: "\u265F", class: "black-piece"},
    "bR" => %{symbol: "\u265C", class: "black-piece"},
    "bN" => %{symbol: "\u265E", class: "black-piece"},
    "bB" => %{symbol: "\u265D", class: "black-piece"},
    "bQ" => %{symbol: "\u265B", class: "black-piece"},
    "bK" => %{symbol: "\u265A", class: "black-piece"}
  }
